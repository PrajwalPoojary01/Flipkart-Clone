...
const ProductDetail =({product})=>{
    ...
    return(
        <>
            ...
            <SmallText>
                <Typography><StyledBadge/>Get extra 20% Off upto ₹100 on 1 item(s) T&C</Typography>
                <Typography><StyledBadge/>Get extra 10% off(price  inclusive of discount) T&C</Typography>
